...
Col_type <- c("character","integer", "integer", rep("character", 5), rep("numeric", 20))

#Load data
all_data <- read.csv("Summary_of_all_Confetti_data/Sum_of_Ery_BM_analysis.csv", stringsAsFactors=FALSE, header=TRUE, colClasses= Col_type)
...
cell_type <- c("TER119_2", "TER119_3", "TER119_4a", "TER119_4b", "TER119_5")
