...
Col_type <- c(rep("character", 3), rep("numeric", 29))

#Load data
all_data <- read.csv("Summary_of_all_Confetti_data/Sum_of_TransplantBM_Prog.csv", stringsAsFactors=FALSE, header=TRUE, colClasses= Col_type)
...
#Exp to analyze
A28 <- filter(all_data, Exp == Cohort & Donor_type == "KO")
