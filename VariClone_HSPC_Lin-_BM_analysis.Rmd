...
Col_type <- c("character","integer", "integer", rep("character", 5), rep("numeric", 44))

#Load data
all_data <- read.csv("Summary_of_all_Confetti_data/Sum_of_Stem_BM_analysis.csv", stringsAsFactors=FALSE, header=TRUE, colClasses= Col_type)
